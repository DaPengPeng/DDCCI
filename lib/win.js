...
exports.getBrightness = function (localID) {
  return new Promise.resolve(winDDC.getBrightness(getMonitorId(localID)))
};

exports.getMaxBrightness = function (localID) {
  return new Promise.resolve(winDDC.getMaxBrightness(getMonitorId(localID)))
};
...
exports.getContrast = function (localID) {
  return new Promise.resolve(winDDC.getContrast(getMonitorId(localID)))
};

exports.getMaxContrast = function (localID) {
  return new Promise.resolve(winDDC.getMaxContrast(getMonitorId(localID)))
};
...
exports._getVCP = function (localID, con) {
  return new Promise.resolve(winDDC._getVCP(getMonitorId(localID), con))
};
