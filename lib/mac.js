...
function queryControl(monitorId, control, index) {
  ...
  return pify(execFile, Promise)('./ddcctl', ['-d', String(monitorId), control, '?'], {cwd: __dirname}).then(function (stdout) {
    if (stdout) {
...
function setControl(monitorId, control, val) {
  ...
  return pify(execFile, Promise)('./ddcctl', ['-d', String(monitorId), control, String(val)], {cwd: __dirname});
}
...
exports._setVCP = function (monitorId, con, val) {
  ...
  return pify(execFile, Promise)('./ddcctl', ['-d', String(monitorId), '-C', con, String(val)], {cwd: __dirname});
};
...
exports._getVCP = function (monitorId, con) {
  ...
  return pify(execFile, Promise)('./ddcctl', ['-d', String(monitorId), '-C', con, '?'], {cwd: __dirname}).then(function (stdout) {
    if (stdout) {
      return value(stdout)
    }
  });
